                ...
                <div class="col-xs-12 col-sm-7">
                    ...
                    <form action="{{route('products.process.checkout')}}" method="POST" class="bill-detail">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <input class="form-control" placeholder="Postcode / Zip" name="zip_code" type="text">
                            </div>
                            <div class="form-group row">
                                <div class="col">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    <input class="form-control" value="{{$checkoutSubtotal+20}}" name="price"   type="tel">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <button class=" btn btn-primary" style="width:120x; height:40px" name="submit" type="submit" >Submit</button>
                        </div>
                    </form>
